...
class mit_b2(MixVisionTransformer):
    def __init__(self, pretrained = False):
        ...
        if pretrained:
            print("Load backbone weights")
            self.load_state_dict(torch.load("model_data/segformer_b2_weights_voc.pth"), strict=False)
...
class TiffTransBlock(MixVisionTransformer):
    def __init__(self, pretrained = False):
        super(TiffTransBlock, self).__init__(
            in_chans=1, embed_dims=[32, 64, 160, 256], num_heads=[1, 2, 5, 8], mlp_ratios=[4, 4, 4, 4],
            qkv_bias=True, norm_layer=partial(nn.LayerNorm, eps=1e-6), depths=[2, 2, 2, 2], sr_ratios=[8, 4, 2, 1],
            drop_rate=0.0, drop_path_rate=0.1)
        if pretrained:
            print("Load backbone weights")
...
class TiffTransBlock1(MixVisionTransformer):
    def __init__(self, pretrained = False):
        super(TiffTransBlock1, self).__init__(
            in_chans=1, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[4, 4, 4, 4],
            qkv_bias=True, norm_layer=partial(nn.LayerNorm, eps=1e-6), depths=[2, 2, 2, 2], sr_ratios=[8, 4, 2, 1],
            drop_rate=0.0, drop_path_rate=0.1)
        if pretrained:
            print("Load backbone weights")
...
class TiffTransBlock2(MixVisionTransformer):
    def __init__(self, pretrained = False):
        super(TiffTransBlock2, self).__init__(
            in_chans=1, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[4, 4, 4, 4],
            qkv_bias=True, norm_layer=partial(nn.LayerNorm, eps=1e-6), depths=[3, 4, 6, 3], sr_ratios=[8, 4, 2, 1],
            drop_rate=0.0, drop_path_rate=0.1)
        if pretrained:
...
class TiffTransBlock5(MixVisionTransformer):
    def __init__(self, pretrained = False):
        super(TiffTransBlock5, self).__init__(
            in_chans=1, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[4, 4, 4, 4],
            qkv_bias=True, norm_layer=partial(nn.LayerNorm, eps=1e-6), depths=[3, 6, 40, 3], sr_ratios=[8, 4, 2, 1],
            drop_rate=0.0, drop_path_rate=0.1)
        if pretrained:
