...
if __name__ == "__main__":
    ...
    if miou_mode == 0 or miou_mode == 1:
        ...
        for image_id in tqdm(image_ids):
            ...
            # --------------------- wyl
            tiff_path = os.path.join(VOCdevkit_path, "VOC2007/TiffImages/" + image_id + ".tiff")
            tiff = tiff_to_array(tiff_path)
            # ---------------------

            image       = segformer.get_miou_png(image, tiff)
    ...
    if miou_mode == 0 or miou_mode == 2:
        ...
        # pred_dir = "img_out\8"
        # image_ids = []
        # for label_name in os.listdir(gt_dir):
        #     image_ids.append(label_name[:-4])
        #---------------wyl
